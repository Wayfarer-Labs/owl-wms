...
@torch.no_grad()
def to_wandb_samples(video, mouse, btn, labels, num_gt_frames, prompts=None):
    ...
    video = draw_frames(video, mouse, btn, labels=labels, num_gt_frames=num_gt_frames, prompts=prompts)
